...
$LANG['poster'] = '图片位';
$LANG['apply'] = '报名管理';
$LANG['exhibitionApply'] = '展会预定';
$LANG['forumApply'] = '论坛报名';
$LANG['subscribe'] = '期刊订阅';
$LANG['release_point_management'] = '发布点管理';
$LANG['extend_setting'] = '扩展配置';
$LANG['report manage'] = '报告管理';
$LANG['report order'] = '订单列表';
?>