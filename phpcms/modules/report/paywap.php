...
class paywap {
    ...
    public function topay(){
    	...
    	if($paymentMethod == 'alipay'){
            ...
            $this->Alipay->returnUrl = 'http://www.caapa.org/index.php?m=report&c=paywap&a=resultPage_alipay';
            $this->Alipay->notifyUrl = 'http://www.caapa.org/index.php?m=report&c=paywap&a=alipayCallback';
