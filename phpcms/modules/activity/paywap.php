...
class paywap {
	...
	function __construct() {
        ...
        $this->Alipay = pc_base::load_sys_class('alipaywap');
        $this->Wxpay = pc_base::load_sys_class('wxpaywap');
    ...
    public function topay(){
    	...
    	if($paymentMethod == 'alipay'){
            ...
            $this->Alipay->returnUrl = 'http://www.caapa.org/index.php?m=activity&c=paywap&a=resultPage_alipay';
            $this->Alipay->notifyUrl = 'http://www.caapa.org/index.php?m=activity&c=paywap&a=alipayCallback';
